...
public class Case215ClosureRegistryDelay02 {
    ...
    public static String execute(String input) {
        String taskName = "closure_registry_delay_02";
        ...
        Supplier<String> later = () -> { RETAINED_AUDIT.add(payload); return payload.get("input"); };
